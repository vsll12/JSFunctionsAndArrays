...
// 1.Chatda olan goods massivinin icinden ada gore obyekt tapmaq ucun funskiya yazin

let input = prompt();

let good = goods.find(good => good.product_name === input);

console.log('good :', good );


// 2. Diapozonda qiymetelere gore filter etmek lazimdir
...
let filtered_goods =goods.filter(good => good.product_price >= start && good.product_price <= end );

filtered_goods.forEach(good => console.log(num++," ",good));